...
export default function CardBoardMain() {
    return (
        <div className="CardBoard">
            <Card address="NoSmoking" image="bad-habits" title="Какие у меня зависимости?" text="Давай проверим твою выдержку и подсчитаем, сколько денег ты сумел сэкономить."></Card>
