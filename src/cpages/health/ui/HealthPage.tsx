...
export const HealthPage = () => {
  ...
  const blocks = [
    ...
    { title: 'Алкоголь', subtitle: 'Алкоголь является одной из самых распространенных зависимостей в мире, время освободиться от него.', Icon: FaWineBottle, href: '/dream' },
    ...
    { title: 'Наркотики', subtitle: 'Они приводят к потере контроля над собственной жизнью. Это не то, что пойдет тебе на пользу.', Icon: FaCoffee, href: '/dream' },
    { title: 'Порно', subtitle: 'Это иллюзия, которая искажает восприятие реальных отношений и сексуальности. Время избавиться от неё.', Icon: TbRating18Plus, href: '/dream' },
  ];
